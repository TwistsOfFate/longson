module controller(
    ...
    output logic       w_cp0_sel         ,
    output logic       w_cp0_wen             
...
logic        d_eret, e_eret ;
logic        d_cp0_sel, e_cp0_sel, m_cp0_sel ;
logic        d_cp0_wen, e_cp0_wen, m_cp0_wen ;
...
assign d_eret = (d_op == 6'b010000 && d_funct == 6'b011000) ;

assign w_cp0_sel = (d_op == 6'b010000 && d_c0funct == 5'b00000) ;
assign w_cp0_wen = (d_op == 6'b010000 && d_c0funct == 5'b00100) ;
...
floprc #(34) regE(
    ...
    d_hi_sel, d_lo_sel, d_size, d_hi_wen, d_lo_wen, d_cp0_sel, d_cp0_wen}) ,
    ...
    e_hi_sel, e_lo_sel, e_size, e_hi_wen, e_lo_wen, e_cp0_sel, e_cp0_wen}) 
);
...
flopr  #(19) regM(
    ...
    m_hi_sel, m_lo_sel, m_size, m_hi_wen, m_lo_wen, m_cp0_sel, m_cp0_wen}) 
);
...
flopr  #(11) regW(
    ...
    .d({m_regwrite, m_memtoreg, m_link, m_hi_sel, m_lo_sel, m_hi_wen, m_lo_wen, m_cp0_sel, m_cp0_wen}) ,
    .q({w_regwrite, w_memtoreg, w_link, w_hi_sel, w_lo_sel, w_hi_wen, w_lo_wen, w_cp0_sel, w_cp0_wen}) 
);
